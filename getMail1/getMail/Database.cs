...
namespace getMail
{
    class Database
    {
       ...
       // Metoden åbner SQL-connection og indeholder command.
        ...
        /// <returns></returns>
        public int CreateTicket(string request, DateTime timeStamp, string mailAddress, string ti_status = "ny")
        {
            string sqlString = "INSERT INTO Ticket (request, ti_timeStamp, customer, ti_status) " +
            ...
            myParams.Add(new SqlParameter("@ti_status", ti_status));
